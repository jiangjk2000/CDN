...
benchinit() {
	...
	if  [ ! -e 'speedtest.py' ]; then
		...
		wget https://cdn.jsdelivr.net/gh/msoayu56/speedtest/speedtest.py > /dev/null 2>&1
	fi
	...
	if  [ ! -e 'speedtest_original.py' ]; then
		...
		wget https://cdn.jsdelivr.net/gh/msoayu56/speedtest/speedtest_original.py > /dev/null 2>&1
	fi
	...
	if  [ ! -e 'tools.py' ]; then
		...
		wget https://cdn.jsdelivr.net/gh/oooldking/script/tools.py > /dev/null 2>&1
	fi
	chmod a+rx tools.py
	...
	if  [ ! -e 'fast_com.py' ]; then
		...
		wget https://cdn.jsdelivr.net/gh/sanderjo/fast.com/fast_com.py > /dev/null 2>&1
		wget https://cdn.jsdelivr.net/gh/sanderjo/fast.com/fast_com_example_usage.py > /dev/null 2>&1
	fi
